<footer>
    <ul class="nav justify-content-center" style="padding: 1vh; background-color: #6D071A;">
        ...
        <div class="col-3">
            <li class="nav-item">
                <a class="nav-link" href="views/frontend/articles/mentions.php" style="padding-top: 3vh; color: #ffffff; text-decoration:underline;"><h3 class="typo-footer">Mentions Légales</h3></a>
            </li>
        </div>
    </ul>
</footer>
